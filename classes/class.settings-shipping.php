 ...
 */
class Bundsgaard_Settings_Shipping extends Bundsgaard_Settings implements Bundsgaard_Settings_Template
{
    ...
    public function hasPost(){
        if (isset($_POST['bc_post_shipping'])) {
            $this->post();
        } else if (isset($_POST['bc_patch_shipping'])) {
            $this->patch();
        } else if (isset($_POST['bc_delete_shipping'])) {
            $this->delete();
        }
    }
    ...
    public function patch(){
        ...
        foreach ($options as $key => $shipping) {
